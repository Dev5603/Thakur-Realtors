...
import { RiFacebookBoxFill, RiFacebookBoxLine, RiFacebookCircleLine, RiFacebookLine, RiLinkedinBoxLine } from "react-icons/ri";
          ...
          <div className="footer-meta-col">
            <div className="footer-meta-block">
              <div className="footer-meta-logo">
                <Copy delay={0.1}>
                  <h3 className="lg">Thakur Realtors</h3>
                </Copy>
              </div>
              <Copy delay={0.2}>
        ...
        <div className="container footer-socials">
          <div className="footer-meta-col">
            <div className="footer-socials-wrapper" ref={socialIconsRef}>
              <div className="icon">
                <a href="https://www.facebook.com/profile.php?id=61581734755828" target="_blank"><RiFacebookLine /></a>
              </div>
              <div className="icon">
                <a href="https://www.instagram.com/thakur.realtors/" target="_blank"><RiInstagramLine /></a>
              </div>
              {/* <div className="icon">
                <RiYoutubeLine />
              </div> */}
      ...
      <div className="footer-outro">
        <div className="container">
          <div className="footer-header">
            <h1 style={{ fontWeight: "bold", fontSize: "25vw", background: "linear-gradient(to bottom, #f4f3f0 0%,#8f8d8a 50%,#3f3e3d 100%)", WebkitBackgroundClip: "text", backgroundClip: "text", color: "transparent" }}>Thakur</h1>
          </div>
          <div className="footer-copyright">
            <p>
              Developed by — <span>H&H Media</span>
            </p>
